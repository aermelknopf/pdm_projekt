...
def train(model, dataloader, loss_fn, optimizer=Adam, n_epochs=100, batch_size=32, val_dataloader=None, device='cpu'):
...
dataset = TensorDataset(seq_array, label_array)

val_size = val_data_portion * len(dataset)
...
val_loader = DataLoader(val_set, num_workers=2)
